...
public class PoisonGreenEgg extends ItemFood{

	public PoisonGreenEgg() {
		super(6, 0.5f, false);
		setCreativeTab(EasterCraft.tabEasterCraftEggs);
		setTextureName(EasterCraft.MODID + ":" + "poisonedgreenegg");
		setUnlocalizedName(EasterCraft.MODID + "_" + "PoisonGreenEgg");
