...
public class PoisonOrangeEgg extends ItemFood{

	public PoisonOrangeEgg() {
		super(6, 0.5f, false);
		setCreativeTab(EasterCraft.tabEasterCraftEggs);
		setTextureName(EasterCraft.MODID + ":" + "poisonedorangeegg");
		setUnlocalizedName(EasterCraft.MODID + "_" + "PoisonOrangeEgg");
