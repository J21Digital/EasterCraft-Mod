...
public class PoisonMemeEgg extends ItemFood{

	public PoisonMemeEgg() {
		super(6, 0.5f, false);
		setCreativeTab(EasterCraft.tabEasterCraftEggs);
		setTextureName(EasterCraft.MODID + ":" + "poisonedmemeegg");
		setUnlocalizedName(EasterCraft.MODID + "_" + "PoisonMemeEgg");
